package com.example.jetpackcomposeroadmap.android.ui.autofill
...
@Composable
fun Autofill(navController: NavController) {
    val catagories = listOf(
        "Food", "Brevarage", "Sports", "Learing", "Travels", "Rent", "Bills", "Fees", "others"
    )
...
//                        items(catagories) {title->
//                            CategoryItems(title = title, onSelect = {})
//                        }

                        if (category.isNotEmpty()) {
                            items(catagories.filter {
